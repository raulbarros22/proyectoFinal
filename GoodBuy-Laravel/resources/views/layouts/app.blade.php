...
<head>
  ...
  <meta name="description" content="Comprá Online en GoodBuy. Las mejores ofertas en Computadoras e insumos.">
...
<body>
  ...
  <!-- Footer -->
    {{-- <footer class="section footer-classic bg-image elegant-color-dark"> --}}
     <footer class="elegant-color-dark text-white font-small">
      <div class="container py-3">
        <div class="row">
          <div class="col-md-7">
            <div class="pr-xl-4"><a class="brand" href="index.php">
              ...
              <p>Copyright © 2019 GoodBuy.</p>
              <p>El uso de este sitio web implica la aceptación de los Términos y Condiciones
          ...
          <div class="col-md-3 py-3">
            ...
            <dl class="contact-list">
              <dt class="">Direccion:</dt>
              <dd class="">Cordoba 790 San Miguel de Tucumán</dd>


              <dt class="">E-mail:</dt>
              <dd>
                <a class="text-white" href="mailto:ventas@goodbuy.com">ventas@goodbuy.com</a>
              </dd>

              <dt class="">Telefono:</dt>
              <dd>
                <a class="text-white" href="tel:08101234567">0810-123-4567</a>
              </dd>
            </dl>
            {{-- <p class="gb-newsletter-subscription-title">¡Recibí las mejores ofertas!</p>
